...
Dim fKS6 As Boolean, fKS7 As Boolean, fKS8 As Boolean, fKS9 As Boolean
Dim i As Integer
  If (nCode = HC_ACTION) Then
    If wParam = WM_KEYDOWN Or wParam = WM_SYSKEYDOWN Or wParam = WM_KEYUP Or wParam = WM_SYSKEYUP Then
      CopyMemory p, ByVal lParam, Len(p)
        ...
        If Form1.chkDisable(6).Value = 1 Then fKS7 = ((GetKeyState(VK_LWINDOWS)) And (p.vkCode = VK_L)) Or ((GetKeyState(VK_RWINDOWS)) And (p.vkCode = VK_L))
        If Form1.chkDisable(7).Value = 1 Then fKS8 = (p.vkCode = VK_APPSPOPUP)
        If Form1.chkDisable(8).Value = 1 Then fKS9 = (GetKeyState(VK_RWINDOWS) Or GetKeyState(VK_LWINDOWS))
    End If
  End If

  If fKS1 Or fKS2 Or fKS3 Or fKS4 Or fKS5 Or fKS6 Or fKS7 Or fKS8 Or fKS9 Then
